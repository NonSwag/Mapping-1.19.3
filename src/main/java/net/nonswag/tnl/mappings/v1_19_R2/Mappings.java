package net.nonswag.tnl.mappings.v1_19_R3;
...
import net.nonswag.tnl.mappings.v1_19_R3.api.bossbar.NMSBossBar;
import net.nonswag.tnl.mappings.v1_19_R3.api.enchantments.EnchantmentWrapper;
import net.nonswag.tnl.mappings.v1_19_R3.api.entity.NMSArmorStand;
import net.nonswag.tnl.mappings.v1_19_R3.api.entity.NMSEntityHelper;
import net.nonswag.tnl.mappings.v1_19_R3.api.entity.NMSEntityPlayer;
import net.nonswag.tnl.mappings.v1_19_R3.api.entity.NMSFallingBlock;
import net.nonswag.tnl.mappings.v1_19_R3.api.helper.NMSItemHelper;
import net.nonswag.tnl.mappings.v1_19_R3.api.helper.NMSPluginHelper;
import net.nonswag.tnl.mappings.v1_19_R3.api.helper.NMSWorldHelper;
import net.nonswag.tnl.mappings.v1_19_R3.api.item.NMSItem;
import net.nonswag.tnl.mappings.v1_19_R3.api.logger.NMSLogManager;
import net.nonswag.tnl.mappings.v1_19_R3.api.packets.incoming.IncomingPacketManager;
import net.nonswag.tnl.mappings.v1_19_R3.api.packets.outgoing.OutgoingPacketManager;
import net.nonswag.tnl.mappings.v1_19_R3.api.player.NMSPlayer;
import net.nonswag.tnl.mappings.v1_19_R3.listeners.GlobalPacketHandler;
