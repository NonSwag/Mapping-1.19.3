package net.nonswag.tnl.mappings.v1_19_R2;
...
import net.nonswag.tnl.mappings.v1_19_R2.api.bossbar.NMSBossBar;
import net.nonswag.tnl.mappings.v1_19_R2.api.enchantments.EnchantmentWrapper;
import net.nonswag.tnl.mappings.v1_19_R2.api.entity.NMSArmorStand;
import net.nonswag.tnl.mappings.v1_19_R2.api.entity.NMSEntityHelper;
import net.nonswag.tnl.mappings.v1_19_R2.api.entity.NMSEntityPlayer;
import net.nonswag.tnl.mappings.v1_19_R2.api.entity.NMSFallingBlock;
import net.nonswag.tnl.mappings.v1_19_R2.api.helper.NMSItemHelper;
import net.nonswag.tnl.mappings.v1_19_R2.api.helper.NMSPluginHelper;
import net.nonswag.tnl.mappings.v1_19_R2.api.helper.NMSWorldHelper;
import net.nonswag.tnl.mappings.v1_19_R2.api.item.NMSItem;
import net.nonswag.tnl.mappings.v1_19_R2.api.logger.NMSLogManager;
import net.nonswag.tnl.mappings.v1_19_R2.api.packets.incoming.IncomingPacketManager;
import net.nonswag.tnl.mappings.v1_19_R2.api.packets.outgoing.OutgoingPacketManager;
import net.nonswag.tnl.mappings.v1_19_R2.api.player.NMSPlayer;
import net.nonswag.tnl.mappings.v1_19_R2.listeners.GlobalPacketHandler;
